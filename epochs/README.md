...
The model-pilot preregistration is frozen in `evidence/preregistration.md`; activation and
the remaining execution gates are still prerequisites for any model call.
